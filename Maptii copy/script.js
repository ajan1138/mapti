...
class App {
  ...
  #getPosition(){
    if( navigator.geolocation ) {
      navigator.geolocation.getCurrentPosition(this.#loadMap.bind(this), function(){
        alert(`Couldnt get you position`)
      });
      }
  }
  ...
  _moveToPopup(e) {
    ...
    // Method from leaflet library to take the coordinates from this element, and then move the map to that position
    // In leaflet, there is excatly a method to do that
